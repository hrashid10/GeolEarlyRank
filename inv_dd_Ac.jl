...
LATENT_MODEL_PATH = "vae_best_weak.bson" 

# LATENT_MODEL_PATH = "vae_best.bson"        # or "vae_trained_finalmpi.bson"
DATA_DIR          = "./image_train_weak"  # directory containing true permeability images
...
# Save paths
CHECKPOINT_PREFIX = "inv_net_data_weak"
BEST_MODEL_PATH   = "$(CHECKPOINT_PREFIX)_best_weak.bson"
FINAL_MODEL_PATH  = "$(CHECKPOINT_PREFIX)_final_model_weak.bson"
FINAL_LOSS_PATH   = "$(CHECKPOINT_PREFIX)_final_losses_weak.bson"
