...
LATENT_MODEL_PATH = "vae_best_plausible.bson" 

# LATENT_MODEL_PATH = "vae_best.bson"        # or "vae_trained_finalmpi.bson"
DATA_DIR          = "./image_train_plausible"  # directory containing true permeability images
...
# Save paths
CHECKPOINT_PREFIX = "inv_net_data_plausible"
BEST_MODEL_PATH   = "$(CHECKPOINT_PREFIX)_best_plausible.bson"
FINAL_MODEL_PATH  = "$(CHECKPOINT_PREFIX)_final_model_plausible.bson"
FINAL_LOSS_PATH   = "$(CHECKPOINT_PREFIX)_final_losses_plausible.bson"
